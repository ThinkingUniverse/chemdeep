...
from apps.telegram_bot.ui.keyboards import (
    build_models_keyboard,
    build_config_keyboard,
    build_run_actions_keyboard,
    build_help_menu,
)
...
class TestMobileUX(unittest.TestCase):
    def test_keyboards_logic(self):
        ...
        self.assertIn("modelpick:1:0", str(rows))
        ...
        self.assertIn("modelpick:2:8", str(kb2))
    ...
    def test_callback_routing(self, mock_registry):
        ...
        mock_registry.dispatch.assert_called_with("/models page 2", mock.ANY)
    ...
    def test_help_routing(self, mock_registry):
        ...
        handle_callback_query(cb, tg, db, settings)
        mock_registry.dispatch.assert_called_with("/help Config", mock.ANY)
